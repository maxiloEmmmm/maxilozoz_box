...
class Application {
  ...
  dynamic bind(String key, Function(Application app, dynamic params) instance, {bool share = true}){
  ...
  void run(){
    runZoned(() {
      ...
      this.di.make('log').set(jsonEncode({'obj': obj.toString(), 'stack': stack.toString()}), this.errorLogKey);
      print(obj);
      print(stack);
    });
  }
